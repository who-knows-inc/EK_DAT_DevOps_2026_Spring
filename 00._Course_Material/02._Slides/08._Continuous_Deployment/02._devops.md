...
One way to test if you understand something is if you can explain it at 3 different levels. Try to explain it to:

* Your grandmother?

* Friends with some baseline technological skillset but not programmers?

* Peers in the same semester who aren't taking the class?
...
<img src="./assets_devops/devops_handbook_three_ways.png" alt="devops handbook three ways" style="height: 50vh;">

**Disclaimer**: The Three Ways is only one way to think about DevOps. It's rooted in Lean principles. 
...
# Meta-slide: What this course is really about

I've said it before, but this course actually contains two ongoing tracks:
