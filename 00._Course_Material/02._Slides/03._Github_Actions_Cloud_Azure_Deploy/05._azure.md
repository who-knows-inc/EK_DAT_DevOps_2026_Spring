...
We will now try to create a VM manually.

This repository contains scripts in case that doesn't work:

https://github.com/anderslatif/EK_Azure

It also contains a guide on how to look up [available regions](https://github.com/anderslatif/EK_Azure/blob/main/tutorials/available_regions/azure_available_regions.md) specific to your account. This is a quirk due to the new `@ek.dk` setup.
