...
We don't want to run our web crawler on:

**Same virtual machine as our server**: This will result in competing resources.

**On a dedicated server**: This will cost us even if the script is idle.

In the next couple of slides, let us discuss different options.
