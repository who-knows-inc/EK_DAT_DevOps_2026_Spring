...
> "*A value stream is an end-to-end set of activities which collectively create value for a customer.*"
...
[Comprehensive list of non-functional requirements](https://quality.arc42.org/articles/iso-25010-update-2023)
