...
<img src="./assets_virtualization_containerization/hypervisor.png" alt="hypervisor" style="height: 22vh; background-color: grey">
...
|----------------------------------------------------------------------------|---------------------------------------------------------------------------------|
| <img src="./assets_virtualization_containerization/containers.png" alt="containers" style="width: 15vw;">  | <img src="./assets_virtualization_containerization/virtual_machines.png" alt="virtual machines" style="width: 15vw;"> |
...
**Reproducibility:** Consistent setup across environments / systems.
...
Containers are not DevOps by default. But they can help you achieve DevOps. 
...
2. **specialization**: Operations (Ops) could create containers that developers could use over and over again.

3. **automation**: Containers can be built over and over again and everything will just work.

Source: Holmes, How a Hotel Company Ran $30B of Revenue in Containers (2020) (DevOps Handbook)
